			...
			<a href="/" class="mr-6 flex items-center space-x-2"
				><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" class="h-6 w-6"
					...
					></line><line
						...
						stroke-width="16"
					></line></svg
				> <span class="hidden font-bold sm:inline-block">BINTROTTER</span></a
			>
		...
		<div class="flex flex-1 items-center justify-between space-x-2 md:justify-end">
			...
			<nav class="flex items-center">
				<a
					...
					rel="noopener noreferrer"
					><div
						class="inline-flex h-8 w-9 items-center justify-center whitespace-nowrap rounded-md px-0 text-xs font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
					>
				...
				<button
					type="button"
					tabindex="0"
					aria-controls="3c2hmE58_w"
					aria-expanded="false"
					data-state="closed"
					id="chPT_SOaPU"
					data-melt-dropdown-menu-trigger=""
					data-menu-trigger=""
					class="inline-flex h-9 w-9 items-center justify-center whitespace-nowrap rounded-md px-0 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
					data-button-root=""
					><svg
						width="24"
						height="24"
					...
					<svg
						...
						></path></svg
					> <span class="sr-only" data-svelte-h="svelte-ntgole">Toggle theme</span></button
				>
			</nav>
		</div>
	</div>
